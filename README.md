...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libmicrohttpd-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libmicrohttpd-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add libmicrohttpd
# for installing globally
pixi global install libmicrohttpd
```
...
It is possible to list all of the versions of `libmicrohttpd` available on your platform:
...
```
pixi search libmicrohttpd --channel conda-forge
```
